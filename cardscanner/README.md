...
Developed as a technology demo for **The Pokémon Company**, CardScanner detects Pokémon and Lorcana cards from webcam or uploaded images. It uses YOLOv8 for object detection and EasyOCR for text extraction. A tiny JSON database provides official card data.
...
- Approximate card condition grading based on edge analysis.
